...
export async function computeAnalyticsSummary(periodInput) {
  ...
  const [
    ...
    // Nur der ECHTE Katalog. `official: true` allein genügt nicht: Die
    // Demo-Kreisligen tragen es ebenfalls und sind exakt deshalb `noindex` –
    // sie sind erfunden. Im Sponsorendokument steht diese Zahl unter
    // „Offizieller WBV-Katalog"; mit den 26 Demo-Ligen darin wäre sie eine
    // Angabe, die ein Sponsor zitiert und die nicht stimmt
