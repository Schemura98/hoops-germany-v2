...
// Zentrale Altersklassen-Normalisierung/-Validierung (Produktregel: nur Senioren/U18/U16).
// Trimmt + matcht case-insensitiv auf den kanonischen Wert (z. B. "u16"/" U16 " → "U16").
