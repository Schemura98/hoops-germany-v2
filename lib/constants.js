...
//
// Vorher standen vier verschiedene Strings an sieben Stellen und widersprachen
// sich: `—` auf der öffentlichen Vereinsseite, „Position offen" im
// Team-Admin-Panel, im Transfermarkt und in zwei Tabs, gar nichts auf
// `/spieler`.
...
// ⚠️ „—" ist raus, weil der Gedankenstrich Tabellensprache ist: In einer
// Spalte mit Kopfzeile trägt er (dort bleibt er, s. /topscorer, /ligen), in
// einer Personenliste ohne Kopf kann ein Fremder nicht unterscheiden zwischen
// „keine Angabe", „keine Position" und „Ladefehler".
