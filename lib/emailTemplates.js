...
// Basis-Layout: Navy-Header mit Wortmarke, weiße Card, optionaler CTA-Button, Footer.
export function emailLayout({ heading, intro, bodyHtml = "", ctaText, ctaUrl, footerNote }) {
  return `
