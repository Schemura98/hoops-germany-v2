...
export function emailLayout({
  ...
  const logo = baseUrl
    ? `<img src="${baseUrl}/images/logo-email.png" alt="Hoops Germany" width="150" style="width:150px;max-width:60%;height:auto;display:block;margin:0 auto;border:0">`
      ...
      <tr><td align="center">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background:#ffffff;border-radius:16px;border:1px solid #e6e9ef;overflow:hidden">
          ...
          <tr><td style="padding:34px 36px 10px">
            ...
            ${title ? `<h1 style="margin:0 0 12px;color:#0f172a;font-size:23px;line-height:1.3;font-weight:800">${title}</h1>` : ""}
            ${intro ? `<p style="margin:0 0 18px;color:#475569;font-size:15px;line-height:1.65">${intro}</p>` : ""}
            ${bodyHtml}
          </td></tr>
          ${
            ctaText && ctaUrl
