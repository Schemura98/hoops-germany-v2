...
export function teamPendingEmail({ teamName, founderName, region, baseUrl }) {
  const bodyHtml = `
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e8ebf0;border-radius:12px;overflow:hidden">
      ...
      <tr>
        <td style="padding:10px 16px;border-bottom:1px solid #eef1f5;color:#64748b;font-size:13px;font-weight:600">Gegründet von</td>
  ...
  return {
    ...
    text: `Neues Team wartet auf Freigabe: ${teamName} (Gründer: ${founderName || "–"}, Region: ${region || "–"}).\nPrüfen: ${baseUrl}/admin/teams\n`,
  };
}

// ---------------------------------------------------------------------------
// 09 – Team freigegeben (an den Gründer)
// ---------------------------------------------------------------------------
