...
export function teamApprovedEmail({ teamName, slug, baseUrl }) {
  return {
    ...
    html: emailLayout({
      ...
      intro:
        "Dein Team wurde von unserem Team geprüft und freigegeben – es ist jetzt öffentlich sichtbar. Lade Mitspieler ein, trage Spiele ein und leg los!",
