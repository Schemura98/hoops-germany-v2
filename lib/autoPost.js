...
export async function syncMatchResultPost(match) {
  try {
    ...
    // sauber trägt.
    //
    // ⚠️ Wortlaut bewusst aus `lib/matchScore.js` übernommen statt neu
    // erfunden – dieselbe Aussage muss überall gleich heißen, sonst entsteht
    // wieder ein Wildwuchs wie bei den Positions-Platzhaltern. „confirmed"
    // heißt: BEIDE Teams haben unabhängig gemeldet und stimmen überein.
    // Alles andere bleibt ausdrücklich vorläufig – ein einseitig gemeldetes
    // Ergebnis als „Endergebnis" zu bezeichnen wäre die Behauptung einer
