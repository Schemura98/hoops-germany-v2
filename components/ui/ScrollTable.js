  ...
  return (
    <div className="relative">
      ...
      <div
        ref={leftRef}
        aria-hidden="true"
        className="pointer-events-none absolute inset-y-0 left-0 w-5 bg-gradient-to-r from-gray-900/10 to-transparent opacity-0 transition-opacity duration-200 motion-reduce:transition-none"
      />
      <div
        ref={rightRef}
        aria-hidden="true"
        className="pointer-events-none absolute inset-y-0 right-0 w-5 bg-gradient-to-l from-gray-900/10 to-transparent opacity-0 transition-opacity duration-200 motion-reduce:transition-none"
      />
    </div>
  );
}
