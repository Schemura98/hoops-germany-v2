...
// Text darauf (ink-950 auf brand-500 = 7,1:1) statt Weiß (2,6:1, wäre unter AA).
const VARIANTS = {
  ...
  danger: "bg-signal-error text-ink-950 hover:brightness-110",
...
export default function Button({
  ...
  const cls = `inline-flex items-center justify-center gap-2 rounded-md font-semibold tracking-tight transition-[color,background-color,border-color,transform,filter] duration-150 ease-out active:scale-[0.97] motion-reduce:transition-none motion-reduce:active:scale-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-2 focus-visible:ring-offset-ink-950 disabled:opacity-60 disabled:pointer-events-none ${
